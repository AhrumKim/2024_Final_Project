...
"Scheduler/Scheduler.src":"../Scheduler/Scheduler.c" "Scheduler/subdir.mk"
...
"Scheduler/Scheduler.o":"Scheduler/Scheduler.src" "Scheduler/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-Scheduler

clean-Scheduler:
	-$(RM) ./Scheduler/Scheduler.d ./Scheduler/Scheduler.o ./Scheduler/Scheduler.src
